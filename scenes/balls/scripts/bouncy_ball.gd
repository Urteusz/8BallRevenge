...
# Konfiguracja
@export var wall_bounce_multiplier: float = 20  # 2x szybciej po odbiciu od ściany
@export var ball_impact_dampening: float = 10   # 0.5x prędkości po uderzeniu w inną bilę (znaczne zwolnienie)
